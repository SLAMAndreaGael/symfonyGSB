...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // slamgsb_home
        if ($pathinfo === '/accueil') {
            return array (  '_controller' => 'SLAM\\GSBBundle\\Controller\\HomeController::indexAction',  '_route' => 'slamgsb_home',);
        }

        // slamgsb_validerconnexion
        if ($pathinfo === '/validerconnexion') {
            return array (  '_controller' => 'SLAM\\GSBBundle\\Controller\\HomeController::validerconnexionAction',  '_route' => 'slamgsb_validerconnexion',);
        }

        // slamgsb_deconnexion
        if ($pathinfo === '/deconnexion') {
            return array (  '_controller' => 'SLAM\\GSBBundle\\Controller\\HomeController::deconnexionAction',  '_route' => 'slamgsb_deconnexion',);
        }
