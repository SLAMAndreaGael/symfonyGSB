...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'slamgsb.pdo' => 'getSlamgsb_PdoService',
    ...
    /**
     * Gets the 'slamgsb.pdo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SLAM\GSBBundle\services\PdoGsb A SLAM\GSBBundle\services\PdoGsb instance.
     */
    protected function getSlamgsb_PdoService()
    {
        return $this->services['slamgsb.pdo'] = new \SLAM\GSBBundle\services\PdoGsb('mysql:host=localhost', 'dbname=bd_gsb', 'root', 'root');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SLAM/GSBBundle/Resources/views'), 'SLAMGSB');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0e37a7327fa5e301a69a7cd94dd0ca4bac788d84');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56670af911ea42.08356324')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SLAMGSBBundle' => 'SLAM\\GSBBundle\\SLAMGSBBundle',
            ...
            'secret' => '0e37a7327fa5e301a69a7cd94dd0ca4bac788d84',
            ...
            'kernel.secret' => '0e37a7327fa5e301a69a7cd94dd0ca4bac788d84',
